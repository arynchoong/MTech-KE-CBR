...
following scripts:
- In Windows: RecipeRecommender.bat
- In UNIX: RecipeRecommender.sh
...
./RecipeRecommender : Folder for the Travel Recommender example.
./RecipeRecommender.bat : The Travel Recommender application for Windows.
./RecipeRecommender.sh : The Travel Recommender application for Unix.
...
jCOLIBRI 2.1 includes 14 new mtechkecbr that implement different
recommenders.
...
-- mtechkecbr
jCOLIBRI includes 16 completely documented mtechkecbr and a stand-alone
