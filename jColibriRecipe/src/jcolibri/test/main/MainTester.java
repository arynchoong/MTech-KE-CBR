...
/**
 * Main tester application that executes all the mtechkecbr 
...
public class MainTester extends JFrame
{
	...
	mapDialog.setTitle("jCOLIBRI2 mtechkecbr Map");
    ...
    {
	MainTester main = new MainTester("jcolibri/test/main/mtechkecbr.config");
